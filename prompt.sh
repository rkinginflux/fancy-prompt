...
##==============================================================================
	...
	local user_config_file="$HOME/.config/shell/shell-prompt.config"
	local root_config_file="/etc/shell/shell-prompt.root.config"
	local sys_config_file="/etc/shell/shell-prompt.config"
